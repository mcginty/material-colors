...
```
```
compile 'com.github.mcginty:material-colors:1.0.2'
```
###### See https://jitpack.io/#mcginty/material-colors/1.0.2 if you are unfamiliar with the structure of build.gradle files.
